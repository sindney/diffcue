...
Left-panel tree view of the opened folder, annotated with git status (added/modified/deleted/untracked/renamed) at file and aggregated folder levels; clicking a file opens it in the diff viewer.
