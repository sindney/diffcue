...
A keyboard-driven command palette (Cmd+P / Ctrl+P) that filters and dispatches the same actions the toolbar and menubar expose, with no duplicated action logic.
